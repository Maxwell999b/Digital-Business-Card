  ...
  <section className="projects">
    ...
    <div className="projects--grid">
      <a href="https://anime-cards-anime-gogo-tv.vercel.app/" target="_blank" className="projects--card">
        <img src="../src/assets/1.png" alt="Project 1" className="projects--image" />
        <img src="../src/assets/1-2.png" alt="Project 1 Hover" className="projects--image-hover" />
      ...
      <a href="https://pixel-store-seven.vercel.app/" target="_blank" className="projects--card">
        <img src="../src/assets/2.png" alt="Project 2" className="projects--image" />
        <img src="../src/assets/2-2.png" alt="Project 2 Hover" className="projects--image-hover" />
        <div className="projects--overlay">
          <p className="projects--text">
      ...
      <a href="https://maxwell999b.github.io/Front-End-Portfolio/" target="_blank" className="projects--card">
        <img src="../src/assets/4.png" alt="Project 4" className="projects--image" />
        <img src="../src/assets/4-2.png" alt="Project 4 Hover" className="projects--image-hover" />
        <div className="projects--overlay">
          <p className="projects--text">
      ...
      <a
        ...
        target="_blank"
        className="projects--card">
        <img src="../src/assets/3.png" alt="Project 3" className="projects--image" />
        <img src="../src/assets/3-2.png" alt="Project 3 Hover" className="projects--image-hover" />
        <div className="projects--overlay">
          <p className="projects--text">
